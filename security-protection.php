...
define('SECURITY_PROTECTION_VERSION', '2.3');
...
function secprot_plugin_meta($links, $file) {
	if ( $file == plugin_basename( __FILE__ ) ) {
		$row_meta = array(
			'support' => '<a href="http://web-profile.com.ua/wordpress/plugins/security-protection/" target="_blank"><span class="dashicons dashicons-editor-help"></span> ' . __( 'Security-Protection', 'security-protection' ) . '</a>',
			'donate' => '<a href="http://web-profile.com.ua/donate/" target="_blank"><span class="dashicons dashicons-heart"></span> ' . __( 'Donate', 'security-protection' ) . '</a>',
			'pro' => '<a href="http://codecanyon.net/item/silver-bullet-pro/15171769?ref=webvitalii" target="_blank" title="Speedup and protect WordPress in a smart way"><span class="dashicons dashicons-star-filled"></span> ' . __( 'Silver Bullet Pro', 'security-protection' ) . '</a>'
		);
